...
# getStrips.py  - input : point cloud (Room here).
# 				- output : pointclouds containg points at a certain height.

# Assumes that the y-axis of the first frame (which is the global frame), is aligned with the normal to the floor.

# Usage :  python getStrips.py /path/to/inputCloud /directory/to/output
...
if __name__ == '__main__':
	...
	for i in range(-10, 11):
		...
		target_filename = target_ply+"{}".format(i*0.1)+".ply"

		get_target_ply(source_ply, target_filename, i*0.1, width)
